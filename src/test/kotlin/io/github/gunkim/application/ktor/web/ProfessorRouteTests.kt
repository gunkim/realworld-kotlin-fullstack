package io.github.gunkim.application.ktor.web

import io.github.gunkim.application.ktor.plugins.configureSerialization
import io.github.gunkim.application.ktor.web.professor.addStudent
import io.github.gunkim.application.noplatform.persistence.FakeProfessorRepository
import io.github.gunkim.application.noplatform.usecase.professor.AddStudentService
